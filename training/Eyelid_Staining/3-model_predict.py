...
weight_filename = project_name + '_from_scratch.h5'
...
model.load_weights(os.path.join(weight_dir, weight_filename))
...
if not os.path.exists(model_dir):
    os.mkdir(model_dir)
model.save(os.path.join(model_dir, 'model_for_'+project_name+'_analysis.h5'))
...
imgs_mask_test = np.float32(imgs_mask_test>0.5) 
